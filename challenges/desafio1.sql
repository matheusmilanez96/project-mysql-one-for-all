...
VALUES
  ...
  ('Don\'t Stop Me Now', '2', NULL),
  ('Under Pressure', '3', NULL),
  ('Como Nossos Pais', '4', NULL),
  ('O Medo de Amar é o Medo de Ser Livre', '5', NULL),
  ('Samba em Paris', '6', NULL),
  ('The Bard\'s Song', '7', NULL),
  ('Feeling Good', '8', NULL);
